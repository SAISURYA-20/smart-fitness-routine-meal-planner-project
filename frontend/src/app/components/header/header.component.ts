    ...
    <div class="mobile-menu-overlay" [class.active]="mobileMenuOpen" (click)="toggleMobileMenu()">
      <div class="mobile-menu" (click)="$event.stopPropagation()">
        ...
        <nav class="mobile-nav">
          ...
          <mat-divider style="margin: 8px 0; opacity: 0.1;"></mat-divider>
          <a routerLink="/trainer-dashboard" routerLinkActive="active" (click)="toggleMobileMenu()" *ngIf="authService.getCurrentUser()?.role !== 'user'">
            <mat-icon>edit_note</mat-icon> Manage Plans
          </a>
          <a routerLink="/admin-dashboard" routerLinkActive="active" (click)="toggleMobileMenu()" *ngIf="authService.getCurrentUser()?.role === 'admin'">
...
export class HeaderComponent {
  ...
  getCurrentPageTitle(): string {
    ...
    const titles: Record<string, string> = {
      ...
      '/progress': 'Progress',
      '/settings': 'Settings',
      '/trainer-dashboard': 'Plan Management',
